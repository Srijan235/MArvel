...
export const FormWrapper = styled.div`
  ...
  .ant-btn {
    ...
    &.facebook-btn {
      ...
      background-color: ${themeGet('color.7', '#3b5998')} !important;
    }
    &.github-btn {
      border-color: ${themeGet('color.14', '#00ACEE')};
      background-color: ${themeGet('color.14', '#00ACEE')} !important;
    }
    &.firebase-btn {
      border-color: ${themeGet('color', '#FFCB2B')};
      background-color: ${themeGet('color', '#FFCB2B')} !important;
    }
    &.google-btn {
      border-color: ${themeGet('color.10', '#dd4b39')};
      background-color: ${themeGet('color.10', '#dd4b39')} !important;
    }
  }
`;
